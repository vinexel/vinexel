            ...
            <ul class="inline-flex *:min-h-header-height *:inline-flex *:items-center">
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-pc-toggle="dropdown" href="#" role="button" aria-haspopup="false" data-pc-auto-close="outside" aria-expanded="false">
                        <img src="/static/dashkit/images/uploads/{{user_session_photo}}" alt="user-image" class="user-avtar w-10 h-10 rounded-full">
                    </a>
                        ...
                        <div class="dropdown-body py-4 px-5">
                            <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                                <div class="flex mb-1 items-center">
                                    <div class="shrink-0">
                                        <img src="/static/dashkit/images/uploads/{{user_session_photo}}" alt="user-image" class="w-10 rounded-full">
                                    </div>
                                    <div class="grow ms-3">
                                        <h6 class="mb-1">{{user_session_name}} 🖖</h6>
                                        <span>
                                            <a class="__cf_email__">{{user_session_email}}</a>
                                        </span>
                                    </div>
                                </div>
