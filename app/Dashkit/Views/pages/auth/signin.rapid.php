<div class="auth-main relative">
    <div class="auth-wrapper v2 flex items-center w-full h-full min-h-screen">
            ...
            <div class="card sm:my-12 w-full max-w-[480px] border-none shadow-none">
                <div class="card-body sm:!p-10">
                    ...
                    <form action="{{ route('auth.signin') }}" method="POST">
                        <div class="mb-3">
                            <input type="email" name="user_email" class="form-control" id="floatingInput" placeholder="vinexel@vinexel.com" value="vinexel@vinexel.com" required>
                        </div>
                        <div class="mb-4">
                            <input type="password" name="user_password" class="form-control" id="floatingInput1" placeholder="vinexel" value="vinexel" required>
                        </div>
                    ...
                    <h4 class="text-center font-medium mb-4">Login with your social account</h4>
                    <div class="text-center">
                        <div class="grid my-4">
                            ...
                            <button type="button" class="btn mt-2 flex items-center justify-center gap-2 text-theme-bodycolor dark:text-themedark-bodycolor bg-theme-bodybg dark:bg-themedark-bodybg border border-theme-border dark:border-themedark-border hover:border-primary-500 dark:hover:border-primary-500">
                                <img src="{{asset('auth/images/twitter.svg')}}" alt="img">
        ...
        <div class="auth-sidecontent">
            <img src="{{asset('auth/images/img-auth-sideimg.jpg')}}" alt="images" class="img-fluid h-screen hidden lg:block">
        </div>
