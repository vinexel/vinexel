<div class="col-span-12">
    <div class="card welcome-banner bg-primary-800">
        <div class="absolute opacity-50 inset-0 z-10 bg-right-bottom bg-[length:100%] bg-no-repeat bg-[url('../static/dashkit/dashboard/images/widget/img-dropbox-bg.svg')]"></div>
        <div class="card-body relative z-20">
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 sm:col-span-12">
                    <div class="p-4">
                        <h2 class="text-white">Explore Dashkit</h2>
                        <p class="text-white my-5">This is an example of how you can change the logic according to the preferences and needs of each system, making Vinexel a powerful framework with many features will come in the future update.</p>
                        <a href="https://codecanyon.net/user/visioniconic" class="btn text-white border-white">Exclusive on Codecanyon</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-span-12 lg:col-span-9">
    <div class="card">
        <div class="card-body">
            ...
            <h5 class="ltr:text-right rtl:text-left my-2">
                5.44% <span class="badge bg-success-500 text-white">+2.6%</span>
            </h5>
...
<div class="col-span-12 lg:col-span-3">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Project - Dashkit</h5>
        </div>
        <div class="card-body">
            <div class="mb-3">
                <p class="mb-2">
                    Release v1.2.0 <span class="float-right">70%</span>
                </p>
                <div class="w-full bg-theme-bodybg rounded-lg h-2 mb-4 dark:bg-themedark-bodybg">
                    <div class="bg-primary-500 h-full rounded-lg" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        ...
        <div class="card-body border-bottom pb-0">
            ...
            <ul class="flex flex-wrap w-full text-center nav-tabs border-b border-theme-border dark:border-themedark-border">
                <li class="group active">
                    <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-1" class="inline-block mr-6 py-4 transition-all duration-300 ease-linear border-b-2 border-transparent group-[.active]:text-primary-500 group-[.active]:border-primary-500 hover:text-primary-500 active:text-primary-500">All Transaction</a>
                </li>
                <li class="group">
                    <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-2" class="inline-block mr-6 py-4 transition-all duration-300 ease-linear border-b-2 border-transparent group-[.active]:text-primary-500 group-[.active]:border-primary-500 hover:text-primary-500 active:text-primary-500">Success</a>
                </li>
                <li class="group">
                    <a href="javascript:void(0);" data-pc-toggle="tab" data-pc-target="tran-3" class="inline-block mr-6 py-4 transition-all duration-300 ease-linear border-b-2 border-transparent group-[.active]:text-primary-500 group-[.active]:border-primary-500 hover:text-primary-500 active:text-primary-500">Pending</a>
                </li>
            </ul>
        </div>
                ...
                <div class="col-span-12 md:col-span-6">
                    <div class="grid">
                        <button class="btn btn-outline-secondary grid">
                            <span class="truncate w-full">View all Transaction History</span>
                        </button>
                    </div>
                </div>
                <div class="col-span-12 md:col-span-6">
                    <div class="grid">
                        <button class="btn btn-primary grid">
                            <span class="truncate w-full">Create new Transaction</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-12 gap-3 mt-4">
                <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                        <p class="mb-1 relative inline-flex items-center gap-2">
                            <span class="rounded-full w-2 h-2 inline-block bg-primary-500"></span>
                            <span>Item01</span>
                        </p>
                        <h6 class="mb-0">
                            $23,876
                ...
                <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                        <p class="mb-1 relative inline-flex items-center gap-2">
                            <span class="rounded-full w-2 h-2 inline-block bg-warning-500"></span>
                            <span>Item02</span>
                        </p>
                        <h6 class="mb-0">
                            $23,876
                ...
                <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                        <p class="mb-1 relative inline-flex items-center gap-2">
                            <span class="rounded-full w-2 h-2 inline-block bg-success-500"></span>
                            <span>Item03</span>
                        </p>
                        <h6 class="mb-0">
                            $23,876
                ...
                <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                        <p class="mb-1 relative inline-flex items-center gap-2">
                            <span class="rounded-full w-2 h-2 inline-block bg-info-500"></span>
                            <span>Item04</span>
                        </p>
                        <h6 class="mb-0">
                            $23,876
